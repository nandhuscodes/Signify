...
classifier = Classifier("word_model.h5", "labels.txt")
...
labels = ['Bathroom', 'Break', 'Call', 'Cute', 'Dad', 'Dislike', 'Drink', 'Fighting', 'Food', 'Happy', 'Hello', 'I Love You', 'Its Me', 'Like', 'Milk', 'Mom', 'Name', 'No', 'Ok', 'Peace', 'Promise', 'Ready', 'Saying', 'Sibling', 'Silence', 'Stop', 'Terrific', 'Thank You', 'Water', 'Yes']
